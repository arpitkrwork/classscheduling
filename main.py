...
Professor.professors = [Professor("deepak"), Professor("amit"), Professor("anika"),
                        Professor("ishan"), Professor("deepali")]
...
def convert_input_to_bin():
    ...
    cpg = [CourseClass.find("hu100a"), Professor.find("deepak"), Group.find("a"),
           CourseClass.find("hu100b"), Professor.find("deepak"), Group.find("a"),
           CourseClass.find("mt111"), Professor.find("amit"), Group.find("a"),
           CourseClass.find("cs152"), Professor.find("ishan"), Group.find("a"),
           CourseClass.find("hu160"), Professor.find("deepak"), Group.find("b"),
           CourseClass.find("ch110"), Professor.find("anika"), Group.find("e"),
           CourseClass.find("cs101"), Professor.find("ishan"), Group.find("e"),
           CourseClass.find("cs101 lab"), Professor.find("ishan"), Group.find("e")
           ]
